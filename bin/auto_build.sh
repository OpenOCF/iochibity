...
then
	...
	then
		build_darwin_unsecured true
		build_darwin_unsecured false
		build_darwin_secured true
		build_darwin_secured false
	elif [ $1 = 'darwin_unsecured_with_ra' ]
	then
		build_darwin_unsecured_with_ra true
		build_darwin_unsecured_with_ra false
	# elif [ $1 = 'darwin_secured_with_ra' ]
	# then
	# 	build_darwin_secured_with_ra true
	# 	build_darwin_secured_with_ra false
	elif [ $1 = 'darwin_unsecured' ]
	then
		build_darwin_unsecured true
		build_darwin_unsecured false
	elif [ $1 = 'darwin_secured' ]
	then
		build_darwin_secured true
		build_darwin_secured false
