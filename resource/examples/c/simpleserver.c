...
public:
	...
	// "generates a forwarding call wrapper for f" (i.e. entityHandler)
	// bind: PH::_1 means pass "this" as first arg to entityHandler
        EntityHandler cb = std::bind(&LightResource::entityHandler, this,PH::_1);
	// now cb can be applied to an arg; as a callback it will be applied to a request ("this")
	// q: why not just pass the address of the fn?

        // This will internally create and register the resource.
	// register
	// resource/src/OCPlatform.cpp fwd to resource/src/OCPlatform_impl.cpp
	// creates a platform thingie?
...
{
    PrintUsage();
    // resource/csdk/stack/include/octypes.h:} OCPersistentStorage;
    ...
    // OCPlatform: resource/src/OCPlatform.cpp
    // Configure: resource/src/OCPlatform.cpp, fwd to resource/src/OCPlatform_impl.cpp
    // calls OCRegisterPersistentStorageHandler in resource/csdk/stack/src/ocstack.c,
    //  stores cfg in local static var
