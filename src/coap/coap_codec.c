...
#ifdef ENABLE_TCP
        if (info->payloadSize == 0 && (code == (CASignalingCode_t)CA_CSM || code == CA_PING ||
...
LOCAL CAResult_t CAParsePayloadFormatHeadOption(uint16_t formatOption, CAPayloadFormat_t format,
