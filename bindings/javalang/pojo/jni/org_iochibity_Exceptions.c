...
char* get_stack_rc_string(int code) {
    switch(code) {
	// typedef enum
	// {
	...
	break;
    case OC_STACK_INVALID_QUERY: return "OC_STACK_INVALID_QUERY"; break;
    case OC_STACK_INVALID_IP: return "OC_STACK_INVALID_IP"; break;
	// OC_STACK_INVALID_PORT,
	// OC_STACK_INVALID_CALLBACK,
    case OC_STACK_INVALID_METHOD: return "OC_STACK_INVALID_METHOD"; break;
    case OC_STACK_INVALID_PARAM: return "OC_STACK_INVALID_PARAM"; break;
			    ...
			    const char* message)
{
    ...
    jthrowable e = (*env)->NewObject(env, clazz, ctor,
				     code,
				     (*env)->NewStringUTF(env, get_stack_rc_string(code)),
