...
WARNING: if you are using msys/mingw on windows, the config will be
based on the mingw environment, but the default toolchain is msvc,
which is a different environment. so you have to #undef the following:
